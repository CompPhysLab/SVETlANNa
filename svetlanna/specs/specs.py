...
class ParameterSaveContext:
    ...
    def __init__(self, parameter_name: str, directory: Path):
        """
        Parameters
        ----------
        parameter_name : str
    ...
    def get_new_filepath(self, extension: str) -> Path:
        ...
        total_files = len(
            list(filter(lambda f: f.suffix == suffix, self._generated_files))
        )
...
ParameterSaveContext_ = TypeVar("ParameterSaveContext_", bound=ParameterSaveContext)
...
class MarkdownRepresentation(Representation[ParameterSaveContext_], metaclass=ABCMeta):
...
class StrRepresentation(Representation[ParameterSaveContext_], metaclass=ABCMeta):
...
class HTMLRepresentation(Representation[ParameterSaveContext_], metaclass=ABCMeta):
...
class ImageRepr(StrRepresentation, MarkdownRepresentation, HTMLRepresentation):
    ...
    def to_str(self, out: TextIO, context: ParameterSaveContext):
        """
        Saves the image to a file and writes a message to the output stream.

            Args:
                out: The output stream to write to.
                context: The parameter save context containing filepath information.
    ...
    def to_markdown(self, out: TextIO, context: ParameterSaveContext):
        """
        Saves the image and writes a Markdown string to the output.

            Args:
                out: The output stream to write to.
                context: The parameter save context containing file path information.
    ...
    def to_html(self, out: TextIO, context: ParameterSaveContext):
        """
        Renders the image as an HTML <img> tag.

            Args:
                out: The output stream to write the HTML to.
                context: The parameter save context.
...
class ReprRepr(StrRepresentation, MarkdownRepresentation, HTMLRepresentation):
    ...
    def to_str(self, out: TextIO, context: ParameterSaveContext):
        """
        Writes the string representation of the value to the output stream.
    ...
    def to_markdown(self, out: TextIO, context: ParameterSaveContext):
        """
        Writes the value as a code block in Markdown format.

            Args:
                out: The output stream to write to.
                context: The parameter save context (unused).
    ...
    def to_html(self, out: TextIO, context: Any):
        """
        Renders the object to an HTML representation.

            This method simply calls `to_str` to generate a string representation
            and writes it to the provided output stream.

            Args:
                out: The output stream to write the HTML to.
                context:  Additional context that might be needed during rendering.
...
class NpyFileRepr(StrRepresentation, MarkdownRepresentation):
    ...
    def to_str(self, out: TextIO, context: ParameterSaveContext):
        """
        Saves the numpy array to a file and writes a message to the output stream.
    ...
    def to_markdown(self, out: TextIO, context: ParameterSaveContext):
        """
        Saves the numpy array to a file and writes a markdown message indicating the filepath.

            Args:
                out: The output stream to write the markdown message to.
                context: The parameter save context providing filepath information.
...
class PrettyReprRepr(ReprRepr, HTMLRepresentation):
    ...
    def __init__(self, value: Any, units: str | None = None):
        """Representation of the parameter as a plain text.
    ...
    def _repr(self) -> str:
        ...
        Returns a string representation of the object.
            ...
            Returns:
                str: A string representing the object's value, including its class name,
                     units (if any), and shape (for tensors).  For constrained parameters,
                     it includes min/max values.
        """
    ...
    def to_str(self, out: TextIO, context: ParameterSaveContext):
        """
        Writes the string representation of the object to the output stream.
    ...
    def to_markdown(self, out: TextIO, context: ParameterSaveContext):
        """
        Writes a markdown representation of the object to the output stream.
    ...
    def to_html(self, out: TextIO, context: ParameterSaveContext):
        """
        Writes the object to an HTML file.
...
class ParameterSpecs:
    ...
    def __init__(
        self, parameter_name: str, representations: Iterable[Representation]
    ) -> None:
        """
        Parameters
        ----------
...
class SubelementSpecs:
    ...
    def __init__(self, subelement_type: str, subelement: "Specsable"):
        """
        Parameters
        ----------
        subelement_type : str
